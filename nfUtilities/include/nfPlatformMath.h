...
public:
   ...
   *
   * @return
   * If the two floats differ by less than the value of the gap.
   */
  static FORCEINLINE bool
  checkEqualF(float _val1,
                   float _val2,
                   float _gap = kFLOAT_EQUAL_SMALL_DIFFERENCE);
  /**
   * @brief
   * Check if two floats are nearly equal.
   *
   ...
   */
  static FORCEINLINE bool
  checkEqualD(float _val1,
                   float _val2,
                   float _gap = kDOUBLE_EQUAL_SMALL_DIFFERENCE);
  /**
   * @brief
   * Check if two floats are nearly equal.
   *
   ...
   */
  static FORCEINLINE bool
  checkEqualL(float _val1,
                   float _val2,
                   float _gap = kLONG_EQUAL_SMALL_DIFFERENCE);
  /**
   * @brief
  ...
  /**
   * @brief
   * The maximum difference for two double numbers to be considered equal to
   * each other.
   */
  static const float kDOUBLE_EQUAL_SMALL_DIFFERENCE;
  /**
   * @brief
   * The maximum difference for two long double numbers to be considered equal
   * to each other.
   */
  static const float kLONG_EQUAL_SMALL_DIFFERENCE;
  /**
   * @brief
...
FORCEINLINE bool
PlatformMath::checkEqualF(float _val1,
                          float _val2,
                          float _gap)
{
